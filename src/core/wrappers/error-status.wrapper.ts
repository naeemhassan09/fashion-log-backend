...
import { ResponseDto } from '../../shared/dtos/generic-response.dto';


const { BAD_REQUEST_MESSAGE, UNAUTHORIZED_MESSAGE, NOT_FOUND_MESSAGE, SERVER_ERROR_MESSAGE } = SERVER_RESPONSES;
